...
VALUES ($1, $2, $3, $4, $5)
RETURNING id, created_at, updated_at, url, user_id, last_fetched_at
`
...
SELECT id, created_at, updated_at, url, user_id, last_fetched_at FROM feeds WHERE user_id = $1
`
...
SELECT id, created_at, updated_at, url, user_id, last_fetched_at FROM feeds
